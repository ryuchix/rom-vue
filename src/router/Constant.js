export const constant = {
  ...
  filterMonsters: 'https://api.ragnarokmobile.net/api/filter-monsters',
  
  getEquipments: 'https://api.ragnarokmobile.net/api/equipments',
  getEquipment: 'https://api.ragnarokmobile.net/api/equipment/',
  filterEquipments: 'https://api.ragnarokmobile.net/api/filter-equipments',
  ...
  filterCards: 'https://api.ragnarokmobile.net/api/filter-cards',
  ...
  getWeeklies: 'https://api.ragnarokmobile.net/api/getWeeklies'
